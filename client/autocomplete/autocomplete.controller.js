(function () {
    ...
    var MaterialAutocompleteCntrl = function ($scope, $element, $q, $timeout) {
        ...
        self.matchMap = function(displayEmail , displayPicture , displaycolor){
        ...
        function positionDropdown() {
            ...
            var windoWheight = $(window).height(),
                ...
                inputTopSimple = $('.acDirectiveAutocomplete').offset().top,
                inputHeightsimple = $('.acDirectiveAutocomplete').height(),
                dropAutocomplete = document.getElementsByClassName("acDropdownAutocomplete")[0],
                upperHeight = (inputTopSimple - scrollTop),
                bottomDistance = ( windoWheight + scrollTop ) - (inputTopSimple + inputHeightsimple),
                
                inputTopColor = $('.acDirectiveAutocompleteColor').offset().top,
                inputHeightColor = $('.acDirectiveAutocompleteColor').height(),
                dropAutocompleteColor = document.getElementsByClassName("acDropdownAutocompleteColor")[0],
                upperHeightColor = (inputTopColor - scrollTop),
                bottomDistanceColor = ( windoWheight + scrollTop ) - (inputTopColor + inputHeightColor), 
                
                
                inputTopProfile = $('.acDirectiveAutocompleteProfile').offset().top,
                inputHeightProfile = $('.acDirectiveAutocompleteProfile').height(),
                dropAutocompleteProfile = document.getElementsByClassName("acDropdownAutocompleteProfile")[0],
                upperHeightProfile = (inputTopProfile - scrollTop),
                bottomDistanceProfle = ( windoWheight + scrollTop ) - (inputTopProfile + inputHeightProfile);
            ...
            $timeout(function () {
                if (bottomDistanceColor < upperHeightColor && bottomDistanceColor < dropdownHeight) {
                    self.isDropUp = true;
                    dropAutocompleteColor.style.top = "-202px";
                    //console.log('hello1');
                }
                else if (upperHeightColor < dropdownHeight && bottomDistanceColor > dropdownHeight) {
                    self.isDropUp = false;
                    dropAutocompleteColor.style.top = "63px";
                    //console.log('hello2');
             ...
             $timeout(function () {
                if (bottomDistanceProfle < upperHeightProfile && bottomDistanceProfle < dropdownHeight) {
                    self.isDropUp = true;
                    dropAutocompleteProfile.style.top = "-202px";
                    //console.log('hello1');
                }
                else if (upperHeightProfile < dropdownHeight && bottomDistanceProfle > dropdownHeight) {
                    self.isDropUp = false;
                    dropAutocompleteProfile.style.top = "63px";
                    //console.log('hello2');
